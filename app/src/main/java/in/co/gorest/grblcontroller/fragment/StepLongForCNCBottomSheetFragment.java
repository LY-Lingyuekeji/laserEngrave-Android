...
public class StepLongForCNCBottomSheetFragment extends BottomSheetDialogFragment {

    // 用于日志记录的标签
    private static final String TAG = StepLongForCNCBottomSheetFragment.class.getSimpleName();
    // 用于管理和访问增强的共享偏好设置实例
    ...
    public StepLongForCNCBottomSheetFragment() {
    }


    public static StepLongForCNCBottomSheetFragment newInstance() {
        return new StepLongForCNCBottomSheetFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_step_long_for_cnc_bottom_sheet, container, false);
    }
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    ...
                    case R.id.rb_20:
                        ...
                        sharedPref.edit().putDouble(getString(R.string.preference_step_long_cnc), 20.0).apply();
                        // 设置选中
                        rb20.setChecked(true);
                        // 隐藏弹窗
                        dismiss();
                    ...
                    case R.id.rb_50:
                        ...
                        sharedPref.edit().putDouble(getString(R.string.preference_step_long_cnc), 50.0).apply();
                        // 设置选中
                        rb50.setChecked(true);
                        // 隐藏弹窗
                        dismiss();
                    ...
                    case R.id.rb_100:
                        ...
                        sharedPref.edit().putDouble(getString(R.string.preference_step_long_cnc), 100.0).apply();
                        // 设置选中
                        rb100.setChecked(true);
                        // 隐藏弹窗
                        dismiss();
