...
public class StepGeneralForCNCBottomSheetFragment extends BottomSheetDialogFragment {

    // 用于日志记录的标签
    private static final String TAG = StepGeneralForCNCBottomSheetFragment.class.getSimpleName();
    // 用于管理和访问增强的共享偏好设置实例
    ...
    public StepGeneralForCNCBottomSheetFragment() {
    }


    public static StepGeneralForCNCBottomSheetFragment newInstance() {
        return new StepGeneralForCNCBottomSheetFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_step_general_for_cnc_bottom_sheet, container, false);
    }
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.rb_0_5:
                        ...
                        sharedPref.edit().putDouble(getString(R.string.preference_step_general_cnc), 0.5).apply();
                        // 设置选中
                        rb05.setChecked(true);
                        // 隐藏弹窗
                        dismiss();
                    ...
                    case R.id.rb_2:
                        ...
                        sharedPref.edit().putDouble(getString(R.string.preference_step_general_cnc), 2.0).apply();
                        // 设置选中
                        rb2.setChecked(true);
                        // 隐藏弹窗
                        dismiss();
                        ...
                        break;
                    case R.id.rb_3:
                        // 设置共享偏好设置保存的步长（常规）运动参数实例为 3mm
                        sharedPref.edit().putDouble(getString(R.string.preference_step_general_cnc), 3.0).apply();
                        // 设置选中
                        rb3.setChecked(true);
                        // 隐藏弹窗
                        dismiss();
