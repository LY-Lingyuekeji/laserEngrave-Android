...
public class BaseDialog {
     ...
     * @param negativeListener  取消按钮点击事件
     */
    public static void showCustomDialogWithCheck(Context context, String title, String content, String positiveText, String negativeText,
                                        View.OnClickListener positiveListener, View.OnClickListener negativeListener, View.OnClickListener selectListener) {

        // 创建一个Dialog
        Dialog dialog = new Dialog(context, R.style.CustomDialog);

        // 自定义布局
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_custom_with_check, null);
        ...
        TextView dialogTitle = view.findViewById(R.id.dialog_title);
        TextView dialogContent = view.findViewById(R.id.dialog_content);
        ImageView dialogSelect = view.findViewById(R.id.dialog_select);
        TextView btnCancel = view.findViewById(R.id.dialog_cancel);
        TextView btnOk = view.findViewById(R.id.dialog_ok);
        ...
        dialogSelect.setOnClickListener(v -> {
