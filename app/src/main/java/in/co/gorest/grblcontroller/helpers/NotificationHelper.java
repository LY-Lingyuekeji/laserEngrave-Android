...
public class NotificationHelper extends ContextWrapper {
    ...
    public void createChannels(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            mChannelOne.setLightColor(getColor(R.color.colorBlue));
            ...
            mChannelTwo.setLightColor(getColor(R.color.colorBlue));
            ...
            mChannelThree.setLightColor(getColor(R.color.colorBlue));
